...
export const receptionMathsBank: SkillSeed[] = [
  {
    ...
    datasetSkillIds: ['R-N-001', 'R-N-006'],
    source: ORIGINAL,
    licence: LICENCE,
  ...
  },
  {
    ...
    answerEntry: 'tap-0-10',
    curriculumVersion: 'reception-maths-v1',
    datasetSkillIds: ['R-N-008', 'R-P-001'],
    source: ORIGINAL,
    licence: LICENCE,
  ...
  },
  {
    ...
    answerEntry: 'tap-0-10',
    curriculumVersion: 'reception-maths-v1',
    datasetSkillIds: ['R-N-004', 'R-N-005', 'R-P-002'],
    source: ORIGINAL,
    licence: LICENCE,
  ...
  },
  {
    ...
    answerEntry: 'keypad',
    curriculumVersion: 'year3-maths-v1',
    datasetSkillIds: ['Y3-NPV-002', 'Y3-NPV-004', 'Y3-NPV-005'],
    source: ORIGINAL,
    licence: LICENCE,
  ...
  },
  {
    ...
    answerEntry: 'keypad',
    curriculumVersion: 'year3-maths-v1',
    datasetSkillIds: ['Y3-AS-001', 'Y3-AS-002', 'Y3-AS-003', 'Y3-AS-004'],
    source: ORIGINAL,
    licence: LICENCE,
  ...
  },
  {
    ...
    answerEntry: 'keypad',
    curriculumVersion: 'year3-maths-v1',
    datasetSkillIds: ['Y3-F-001', 'Y3-F-002'],
    source: ORIGINAL,
    licence: LICENCE,
